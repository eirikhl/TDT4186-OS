package Oving3.P3.round_robin.graphics;

import Oving3.P3.round_robin.Process;
import Oving3.P3.round_robin.Simulator;
...
public class SimulationGui extends JFrame implements ActionListener, Runnable {
	...
	private void loadImages() {
		...
		background = loadImage(tk, "Oving3/P3/round_robin/images/background.gif", tracker);
		try {
			tracker.waitForID(0);
	    } catch (InterruptedException ie) {}
	}
