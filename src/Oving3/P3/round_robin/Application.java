...
import Oving3.P3.round_robin.graphics.SimulationGui;
...
public class Application {
    ...
    static void launch(long memorySize, long maxCpuTime, long avgIoTime, long simulationLength, long avgArrivalInterval) {
        Oving3.P3.round_robin.Simulator simulator = new Oving3.P3.round_robin.Simulator(memorySize, maxCpuTime, avgIoTime, simulationLength, avgArrivalInterval);
